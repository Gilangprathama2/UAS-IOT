...
void loop() {
  ...
  if (millis() - lastTime > 10000) {
    ...
    if (!isnan(suhu) && !isnan(kelembapan)) {
      ...
      client.publish("g231220114/g231220117/temperature", String(suhu).c_str());
      client.publish("g231220114/g231220117/humidity", String(kelembapan).c_str());
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("ESP8266Client", mqtt_user, mqtt_password)) {
      ...
      client.subscribe("g231220114/g231220117/control");
    } else {
